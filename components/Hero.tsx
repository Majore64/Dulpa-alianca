...
export const Hero: React.FC<HeroProps> = ({ onNavigate }) => {
  ...
  // w_800: Ajustado para o tamanho máximo renderizado (aprox 720px em tablets/800px em desktops)
  // Elimina desperdício de bytes apontado pelo Lighthouse (Appropriately-sized images)
  // f_auto: Formato automático (AVIF/WebP)
  // q_auto: Qualidade automática
  const heroImageUrl = "https://res.cloudinary.com/dsxketzvb/image/upload/w_800,f_auto,q_auto/v1768555596/IMG_4504_qdtzo6.jpg";
