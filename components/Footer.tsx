        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex gap-4">
              {/* Facebook */}
              <a href="https://www.facebook.com/DuplaAliancaGabineteDeContabilidadeEFiscalidadeLda/?locale=pt_PT" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-finacc-palm hover:border-finacc-palm transition-all group" aria-label="Facebook">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/company/duplaalianca/?originalSubdomain=pt" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-finacc-palm hover:border-finacc-palm transition-all group" aria-label="LinkedIn">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-finacc-palm hover:border-finacc-palm transition-all group" aria-label="Instagram">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
